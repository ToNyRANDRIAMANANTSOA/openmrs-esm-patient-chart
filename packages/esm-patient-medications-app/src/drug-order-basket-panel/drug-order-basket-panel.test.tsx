...
import { type OrderBasketExtensionProps, type DrugOrderBasketItem } from '@tebokaroa/openmrs-esm-patient-common-lib';
...
jest.mock('@tebokaroa/openmrs-esm-patient-common-lib', () => ({
  ...jest.requireActual('@tebokaroa/openmrs-esm-patient-common-lib'),
