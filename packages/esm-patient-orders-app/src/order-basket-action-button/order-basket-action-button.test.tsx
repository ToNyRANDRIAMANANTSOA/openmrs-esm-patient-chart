...
import { type OrderBasketItem, useOrderBasket } from '@tebokaroa/openmrs-esm-patient-common-lib';
import { mockPatient } from 'tools';
import { orderBasketStore } from '@tebokaroa/openmrs-esm-patient-common-lib/src/orders/store';
...
jest.mock('@tebokaroa/openmrs-esm-patient-common-lib/src/useSystemVisitSetting', () => {
  return {
    useSystemVisitSetting: () => mockUseSystemVisitSetting(),
  };
});

jest.mock('@tebokaroa/openmrs-esm-patient-common-lib/src/launchStartVisitPrompt', () => {
